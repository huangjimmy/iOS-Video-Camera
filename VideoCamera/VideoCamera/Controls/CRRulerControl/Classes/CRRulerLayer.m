...
- (void)drawToImage {
    ...
    for (int i = 0; i <= numberOfLines; i++) {
        ...
        NSString *str = self.dataSource != nil? [self.dataSource stringForMark:[NSNumber numberWithFloat:num]]:nil;
        NSString * numStr =  str != nil? str : [textMarkFormater stringFromNumber:[NSNumber numberWithFloat:num]];
