...
@property (nonatomic) BOOL doNotSendEvent;
...
- (id<CRRulerControlDataSource>)dataSource {
    return _dataSource;
}

- (void)setDataSource:(id<CRRulerControlDataSource>)dataSource {
    _dataSource = dataSource;
    self.rulerLayer.dataSource = dataSource;
}
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (oldValue != _value && !self.doNotSendEvent) {
...
- (void)setValue:(CGFloat)value {
    self.doNotSendEvent = YES;
    [self setValue:value animated:NO];
    self.doNotSendEvent = NO;
}
