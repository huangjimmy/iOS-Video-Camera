...
typedef NS_ENUM (uint8_t, DJIRCCalibrationComponent){
	...
	/**
	 *  The vertical dimension of the right stick. To calibrate it, user  should move
	 *  the right stick up and down.
	 */
 ...
 *  or  RTK base station). It is only used when the remote controller supports
 *  multi-device  pairing. Only Supported by Phantom 4 RTK.
 */
