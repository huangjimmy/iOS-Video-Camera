 ...
 *  camera.
 *  
 *  @param camera Camera that sends out the updated zoom state.
 ...
 *  NSNumber data.
 *  
 *  @param camera Camera that sends out the histogram's light values.
 ...
 *  photo file format for Z30 is always `DJICameraPhotoFileFormatJPEG`.
 *  
 ...
 *  the exposure mode is always `DJICameraExposureModeProgram`.
 *  
 ...
 *  2 Enterprise Dual,  the ISO value is always `DJICameraISOAuto`.
 *  
 ...
 *  camera, Z3 camera, Mavic Pro camera and XT 2 camera.
 *  
 ...
 *  Phantom 4 Pro V2.0, Zenmuse X4S, Zenmuse X5S, Zenmuse X7, Mavic 2 Enterprise
 *  camera  and Mavic 2 Enterprise Dual camera.
 *  
 ...
 *  Phantom 4 Advanced, Phantom 4 Pro V2.0, Zenmuse X4S, Zenmuse X5S, Zenmuse X7,
 *  Mavic 2 Enterprise  camera and Mavic 2 Enterprise Dual camera.
 *  
 ...
 *  Enterprise  series. For Mavic 2 Enterprise Dual, the watermark is only applied
 ...
 *  cameras, except Mavic 2 Enterprise Dual thermal camera.
 *  
 ...
 *  imaging cameras, except Mavic 2 Enterprise Dual thermal camera.
 *  
 ...
 *  except Mavic 2 Enterprise Dual thermal camera.
 *  
 ...
 *  Enterprise Dual thermal camera.
 *  
 ...
 *  units results in different value ranges for  Isotherms. Supported only by
 *  thermal imaging cameras except Mavic 2 Enterprise Dual thermal camera. For Mavic
 *  2 Enterprise Dual,  the Isotherm unit is always
 ...
 *  degree Celsius. Supported by thermal imaging cameras.
 *  
 ...
 *  between 0 and 1.0. Supported  only by XT2, Mavic 2 Enterprise Dual and Zenmuse
 *  XT containing Advanced Radiometry capabilities.
 *  
 ...
 *  `DJICamera_DJICameraThermalFFCMode_Auto`.
 *  
 ...
 *  `DJICameraThermalFFCMode` is always `DJICameraThermalFFCModeAuto`.
 *  
 ...
 *  by XT2 camera and Mavic 2 Enterprise Dual Thermal Camera.
 *  
 ...
 *  mode. Different camera results in different value ranges. For XT2 camera, the
 *  valid range is [-8, 8]. For Mavic 2  Enterprise Dual, the valid range is [-40,
 *  40]. Positive value will move the thermal window up. Use this setting to fine-
 *  tune the performance  of MSX display mode and the align PIP mode. Only supported
 *  by XT2 camera and Mavic 2 Enterprise Dual.
 *  
 ...
 *  mode. Different camera results in different value ranges. For XT2 camera, the
 *  valid range is [-8, 8]. For Mavic 2 Enterprise Dual,  the valid range is [-40,
 *  40]. Positive value will move the thermal window up. Only supported by XT2
 *  camera and Mavic 2 Enterprise Dual camera.
 *  
