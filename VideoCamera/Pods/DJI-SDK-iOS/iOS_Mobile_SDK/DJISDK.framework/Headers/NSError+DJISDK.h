...
typedef NS_ENUM (NSInteger, DJISDKFlightControllerError) {
    ...
    /**
     *  Base station paramters have paramter number not match.
     */
    DJISDKFlightControllerErrorBSParamterNumberNotMatch = -4029L,
    

    /**
     *  Base station paramters have paramter length not match.
     */
    DJISDKFlightControllerErrorBSParamterLengthNotMatch = -4030L,


    /**
     *  Base station paramters have paramter read only.
     */
    DJISDKFlightControllerErrorBSParamterReadOnly = -4031L,


    /**
     *  Base station paramters have paramter unknown error.
     */
    DJISDKFlightControllerErrorBSParamterUnknownError = -4032L,
